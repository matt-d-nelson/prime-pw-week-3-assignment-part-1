...
let favoriteFoods = ['lemons', 'watercress chestnuts', 'hardboiled eggs'];
...
let favFoodString = favoriteFoods.join( ' and ' );
...
let favFoodsAndAnUnrelatedListOfAnimalsThatIAmTotallyNOTPlanningOnEating = favoriteFoods.concat(animalArray);
console.log(favFoodsAndAnUnrelatedListOfAnimalsThatIAmTotallyNOTPlanningOnEating);
